...
// Write your code below:
let mazdaFactory = new Factory();
console.log(mazdaFactory.massBuild(35000, mazda3));
...
// Write your code below:
let disCar = new Car('mazda3', "", 'yellow', 'hybrid', 'automatic', 'touring', 'base', 'premium', 'leather', true);
let option = ['weather package', 'satellite radio', 'rear spiler'];
console.log(mazdaFactory.customerBuild(disCar, option));
...
let miataRf2 = new Sport('Miata-RF', 'Grand Touring', 'manual', 'hard top', 'black', 'leather', 'premium', 'premium');
...
console.log(mazdaFactory.massBuild(15000, miataRf));
...
// Write your code below:
let carOps = ['hid headlights', 'sports suspension', 'leather steering wheel', 'heated seats', 'adaptive cruise control'];
console.log(mazdaFactory.customerBuild(miataRf2, carOps));
...
console.log(mazdaFactory.massBuild(35000, trailBlazer));
...
// Write your code below:
let truckOps = ['seat warmers', 'tinted windows', 'fog lamps'];
console.log(mazdaFactory.customerBuild(trailBlazer, truckOps));
